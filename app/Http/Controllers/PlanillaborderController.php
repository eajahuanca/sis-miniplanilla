...
class PlanillaborderController extends Controller
{
    ...
    {
        return view('sistema.planilla.planillaborder.planillaIndex');
    }

    public function store(Request $request)
    {
        //dd($request->input('tipo_archivo'))
        ...
        if($request->input('tipo_archivo')=='pdf')
        {
            $view = \View::make('sistema.planilla.planillaborder.planillaStore', compact('empresa','fechaImpresion','mes','gestion','tipo_empleado','pago'))->render();
        ...
        {
            return view('sistema.planilla.planillaborder.planillaExcel')->with('empresa', $empresa)->with('fechaImpresion', $fechaImpresion)->with('mes',$mes)->with('gestion',$gestion)->with('tipo_empleado',$tipo_empleado)->with('pago',$pago);
        }
    }
