...
class AguinaldoZabimController extends Controller
{
   public function __construct()
    ...
    public function index(){
        ...
        return view('sistema.aguinaldo.zabim.index')->with('aguinaldo', $aguinaldo);
    }
    ...
    public function create()
    {
        ...
        return view('sistema.aguinaldo.zabim.create')->with('empleado',$empleado);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aguinaldoZabim.index');
    }

    public function show($idaguinaldo)
    {
        $aguinaldo = Aguinaldo::find($idaguinaldo);
        return view('sistema.aguinaldo.zabim.show')->with('aguinaldo',$aguinaldo);
    }
    ...
    public function edit($idaguinaldo)
    {
        ...
        return view('sistema.aguinaldo.zabim.edit')->with('aguinaldo',$aguinaldo)->with('empleado',$empleado);
    }
    ...
    public function boletaAguinaldo($idaguinaldo)
    {
    	try{
	        ...
	        $view = \View::make('sistema.aguinaldo.zabim.boleta', compact('aguinaldo','empleado','empresa'))->render();
