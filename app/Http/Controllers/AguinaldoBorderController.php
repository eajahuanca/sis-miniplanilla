...
class AguinaldoBorderController extends Controller
{
    ...
    public function index(){
        ...
        return view('sistema.aguinaldo.border.index')->with('aguinaldo', $aguinaldo);
    }
    ...
    public function create()
    {
        ...
        return view('sistema.aguinaldo.border.create')->with('empleado',$empleado);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('aguinaldoBorder.index');
    }

    public function show($idaguinaldo)
    {
        $aguinaldo = Aguinaldo::find($idaguinaldo);
        return view('sistema.aguinaldo.border.show')->with('aguinaldo',$aguinaldo);
    }
    ...
    public function edit($idaguinaldo)
    {
        ...
        return view('sistema.aguinaldo.border.edit')->with('aguinaldo',$aguinaldo)->with('empleado',$empleado);
    }
    ...
    public function boletaAguinaldo($idaguinaldo)
    {
    	try{
	        ...
	        $view = \View::make('sistema.aguinaldo.border.boleta', compact('aguinaldo','empleado','empresa'))->render();
