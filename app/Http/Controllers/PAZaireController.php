...
class PAZaireController extends Controller
{
    ...
    {
        return view('sistema.aguinaldo.zaire.planilla.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $view = \View::make('sistema.aguinaldo.zaire.planilla.planilla', compact('empresa','fechaImpresion','mes','gestion','tipo_empleado','aguinaldo'))->render();
        ...
        $pdf->loadHTML($view);
        return $pdf->download('PlanillaAguinaldoZAIRE'.date('d-m-Y').date('H-i-s').'.pdf');
    }
