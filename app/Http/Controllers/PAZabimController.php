...
class PAZabimController extends Controller
{
    ...
    {
        return view('sistema.aguinaldo.zabim.planilla.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $view = \View::make('sistema.aguinaldo.zabim.planilla.planilla', compact('empresa','fechaImpresion','mes','gestion','tipo_empleado','aguinaldo'))->render();
        ...
        $pdf->loadHTML($view);
        return $pdf->download('PlanillaAguinaldoZABIM'.date('d-m-Y').date('H-i-s').'.pdf');
    }
