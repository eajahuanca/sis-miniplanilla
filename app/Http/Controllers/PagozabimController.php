...
class PagozabimController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sistema.pago.pagozabim.pagoIndex')->with('pago', $pago);
    }
    ...
    public function create()
    {
        ...
        return view('sistema.pago.pagozabim.pagoCreate')->with('empleado',$empleado)->with('idsalariominimo', $idsalariominimo);
    }
    ...
    public function store(PagoRequest $request)
    {
        ...
        return redirect()->route('pagoZabim.index');
    }

    public function show($id)
    {
        $pago = Pago::find($id);
        return view('sistema.pago.pagozabim.pagoShow')->with('pago',$pago);
    }
    ...
    public function edit($id)
    {
        ...
        return view('sistema.pago.pagozabim.pagoEdit')->with('pago',$pago)->with('empleado',$empleado)->with('idsalariominimo',$idsalariominimo);
    }
    ...
    public function boletaPago($idPago)
    {
        ...
        $view = \View::make('sistema.pago.pagozabim.pagoReporte', compact('pago','empleado','empresa'))->render();
