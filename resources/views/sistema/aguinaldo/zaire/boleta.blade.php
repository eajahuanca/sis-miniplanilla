...
<html>
<head>
	<title>Boleta de Aguinaldo</title>
	<?php
	...
	<style type="text/css" media="screen">
		...
		.encabezado1{
			background-color: #E88608;/*58ACFA;#58FA58;*/
			border-radius: 3px;
			-webkit-border-radius: 3px;
			-moz-border-radius: 3px;
			margin-top:-0.8em;
...
<div class="miBorde">
	...
	<table width="100%">
		<tbody>
			...
			<tr>
				...
				<td align="right"><div class="pequenos2">Correspondiente a:<b> {{ 'AGUINALDO / '.$aguinaldo->agui_gestion }}</b></div></td>
			</tr>
			<tr>
	...
	<div class="contenidoSueldo">
		<table width="100%">
			...
			<tbody>
				<tr>
					<td align="left"><div class="division11">MESES TRABAJADOS</div></td>
					<td align="right"><div class="division22">{{ $aguinaldo->agui_meses }}</div></td>
					<td align="left"><div class="division11">AFP's 12.71%</td>
					<td align="right"><div class="division33">{{ number_format('0.00',2,'.',',').' Bs.' }}</div></td>
				</tr>
				<tr>
					<td align="left"><div class="division1">HABER BASICO</div></td>
					<td align="right"><div class="division2">{{ number_format($aguinaldo->agui_sueldo,2,'.',',').' Bs.' }}</div></td>
					<td align="left"><div class="division1">RC-IVA 13%</div></td>
					<td align="right"><div class="division3">{{ number_format('0.00',2,'.',',').' Bs.'}}</div></td>
				</tr>
				<tr>
					<td align="left"><div class="division1">BONO DE ANTIGUEDAD</div></td>
					<td align="right"><div class="division2">{{ number_format($aguinaldo->agui_bono,2,'.',',').' Bs.' }}</div></td>
					<td align="left"><div class="division1">OTROS</div></td>
					<td align="right"><div class="division3">{{ number_format('0.00',2,'.',',').' Bs.' }}</div></td>
				</tr>
				<tr>
					<td align="left"><div class="division1">OTROS</div></td>
					<td align="right"><div class="division2">{{ number_format($aguinaldo->agui_otrobono,2,'.',',').' Bs.' }}</div></td>
			...
			<tfoot>
				<tr>
					<th align="left"><div class="pie1">TOTAL GANADO</div></th>
					<th align="right"><div class="pie2">{{ number_format($aguinaldo->agui_totalganado,2,'.',',').' Bs.' }}</div></th>
					<th align="right" colspan="2"><div class="pie3">{{ number_format('0.00',2,'.',',').' Bs.'}}</div></th>
				</tr>
			</tfoot>
		</table>
		<div class="tituloPie">
			<table width="100%">
				<tr>
					<td align="left">LIQUIDO PAGABLE <label style="font-style: italic;font-size: 8px;">(MESES * TOTAL GANADO)/12</label></td>
					<td align="right"><b>{{ number_format($aguinaldo->agui_totalliquido,2,'.',',').' Bs.'}}</b></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<table width="100%">
		<tbody>
			<tr>
				<td align="left" width="20%"><div class="titulosA">Nombre del Empleado</div></td>
				<td align="left" width="45%"><div class="titulosB"><b>: {{ $empleado->em_paterno.' '.$empleado->em_materno.' '.$empleado->em_especial.' '.$empleado->em_nombre}}</b></div></td>
				<td align="right"><div class="pequenos1">Boleta: <b>COPIA</b></div></td>
			</tr>
			<tr>
				<td align="left"><div class="titulosA">Carnet de Identidad</div></td> 
				<td align="left"><div class="titulosB"><b>: {{ $empleado->em_cedula.' '.$empleado->em_expedido }}</b></div></td>
