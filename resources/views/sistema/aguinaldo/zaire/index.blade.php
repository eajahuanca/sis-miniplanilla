...
@section('FormularioTitulo','Aguinaldos de la empresa BBS Zaire LTDA.')
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <span class="hint--top  hint--success" aria-label="Registrar Nuevo Aguinaldo de Zaire Ltda."><a  href="{{ route('aguinaldoZaire.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Adicionar Aguinaldo Zaire Ltda.</a></span>
            </div>
        </div>
    </div>
            ...
            <tr id="{{ $item->id }}">
                ...
                <td align="center">
                    <div class="form-horizontal">
                        @if($item->agui_estado)
                            <span class="hint--top  hint--error" aria-label="Obtener Boleta de Aguinaldo de: {{ $item->nombre_empleado }}"><a href="{{ url('/bpZaire', $item->id) }}" class="btn btn-danger btn-xs"><i class="fa fa-file"></i></a></span>
                        @endif
                        <span class="hint--top  hint--info" aria-label="Actualizar Aguinaldo de: {{ $item->nombre_empleado }}"><a href="{{ route('aguinaldoZaire.edit', $item->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a></span>
                        <span class="hint--top  hint--warning" aria-label="Ver Aguinaldo de: {{ $item->nombre_empleado }}"><a href="{{ route('aguinaldoZaire.show', $item->id) }}" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i></a></span>
                    </div>
                </td>
