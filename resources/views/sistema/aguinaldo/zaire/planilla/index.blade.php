...
@section('FormularioTitulo','Planilla de Aguinaldo Zaire Ltda.')
...
@section('ContenidoPagina')
	{!! Form::open(['route' => 'paZaire.store', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
    <div class="row">
	...
	<div class="form-group">
        <center>
            <span class="hint--top  hint--info" aria-label="Obtener Planilla solicitada"><button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> Obtener Planilla de Aguinaldo Zaire Ltda.</button></span>
        </center>
    </div>
	{!! Form::close() !!}
