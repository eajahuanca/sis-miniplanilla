...
<div class="miBorde">
	...
	<table class="miBordeTabla">
		<thead>
			<tr>
				...
				<td class="miTitulo" width="90px">FIRMA DEL EMPLEADO</td>
			</tr>
		</thead>
		<tbody>	
	...
	<table width="100%">
		<tbody>
			<tr>
				<td width="25%" align="center" class="nombreRepresentante">
					@if($tipo_empleado=='PERMANENTE')
					{{ strtoupper($empresa[0]->empleado->em_nombre.' '.$empresa[0]->empleado->em_paterno.' '.$empresa[0]->empleado->em_materno.' '.$empresa[0]->empleado->em_especial) }}
					@else
						BORIS RICHARD ZABALA HUANCA
					@endif
					<br>_______________________________________________<br>NOMBRE DEL EMPLEADOR O REPRESENTANTE LEGAL</td>
				<td width="25%" align="center" class="nombreRepresentante">
					@if($tipo_empleado)
						{{ $empresa[0]->empleado->em_cedula.' '.$empresa[0]->empleado->em_expedido }}
					@else
						4775179 LP
					@endif
					<br>___________________________________<br>N° DE DOCUMENTO DE IDENTIDAD</td>
