...
@section('FormularioDescripcion','Actualizar datos de Aguinaldo de la Empresa Zabim SRL.')
...
@section('ContenidoPagina')
    {!! Form::model($aguinaldo,['route' => ['aguinaldoZabim.update',$aguinaldo->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar la Actualización"><a href="{{ route('aguinaldoZabim.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
