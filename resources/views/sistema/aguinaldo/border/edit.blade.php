...
@section('FormularioDescripcion','Actualizar datos de Aguinaldo de la Empresa BBS SRL.')
...
@section('ContenidoPagina')
    {!! Form::model($aguinaldo,['route' => ['aguinaldoBorder.update',$aguinaldo->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
        
        @include('sistema.aguinaldo.border.form')
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar la Actualización"><a href="{{ route('aguinaldoBorder.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
