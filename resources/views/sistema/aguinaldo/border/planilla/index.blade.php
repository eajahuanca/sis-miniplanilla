...
@section('FormularioTitulo','Planilla de Aguinaldo Bolivian Border Shop SRL')
...
@section('ContenidoPagina')
	{!! Form::open(['route' => 'paBorder.store', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
    <div class="row">
            ...
            <div class="form-group {{ $errors->has('tipo_empleado')?' has-error':'' }}">
                ...
                <div class="col-md-12">
                    <div class="input-group">
                        ...
                        {!! Form::select('tipo_empleado', ['PERMANENTE' => 'Personal Permanente'], null, ['class' => 'form-control chosen-select-deselect']) !!}
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="form-group">
        <center>
            <span class="hint--top  hint--info" aria-label="Obtener Planilla solicitada"><button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> Obtener Planilla de Aguinaldo BBS SRL</button></span>
        </center>
    </div>
	{!! Form::close() !!}
