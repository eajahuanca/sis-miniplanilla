...
@section('FormularioDescripcion','actualizar actividad registrada en el sistema')
@section('FormularioActual','Actividades')
@section('FormularioDetalle','Actualizar Actividad')
...
@section('ContenidoPagina')
    {!! Form::model($evento,['route' => ['principal.update', $evento->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar la Actualizacion"><a href="{{ url('/listEvent') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
