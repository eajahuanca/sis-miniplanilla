...
@section('FormularioDescripcion','Editar cargo en el sistema, para poder asignar a un personal')
@section('FormularioActual','Cargos')
@section('FormularioDetalle','Editar Cargo')
...
@section('ContenidoPagina')
    {!! Form::model($cargo,['route' => ['cargo.update',$cargo->id], 'method' => 'PUT', 'class' => 'form-horizontal', 'files' => true]) !!}
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar la Actualización"><a href="{{ route('cargo.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
