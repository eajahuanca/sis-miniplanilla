...
@section('FormularioTitulo','Planilla ZAIRE LTDA.')
...
@section('ContenidoPagina')
	{!! Form::open(['route' => 'planillaZaire.store', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
     <div class="row">
	...
	<div class="form-group">
        <center>
            <span class="hint--top  hint--info" aria-label="Obtener Planilla solicitada"><button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i> Obtener Planilla de ZAIRE LTDA</button></span>
        </center>
    </div>
	{!! Form::close() !!}
