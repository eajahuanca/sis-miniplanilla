...
@section('FormularioDescripcion','registrar nueva area en el sistema, para poder asignar a un personal')
@section('FormularioActual','Areas')
@section('FormularioDetalle','Registrar Area')
...
@section('ContenidoPagina')
    {!! Form::open(['route' => 'area.store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true]) !!}
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar el registro"><a href="{{ route('area.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
