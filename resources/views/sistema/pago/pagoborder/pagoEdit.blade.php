...
@section('FormularioDescripcion','Actualizar datos de Pago de la Empresa BBS SRL.')
...
@section('ContenidoPagina')
    {!! Form::model($pago,['route' => ['pagoBorder.update',$pago->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
        
        @include('sistema.pago.pagoborder.pagoForm')
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar la Actualización"><a href="{{ route('pagoBorder.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
