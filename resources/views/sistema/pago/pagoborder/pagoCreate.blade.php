...
@section('ContenidoPagina')
    {!! Form::open(['route' => 'pagoBorder.store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true, 'name' => 'frmpago']) !!}
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar el registro"><a href="{{ route('pagoBorder.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
