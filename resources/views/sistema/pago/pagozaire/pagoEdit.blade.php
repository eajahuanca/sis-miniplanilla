...
@section('FormularioDescripcion','Actualizar datos de Pago de la Empresa ZAIRE LTDA.')
...
@section('ContenidoPagina')
    {!! Form::model($pago,['route' => ['pagoZaire.update',$pago->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar la Actualización"><a href="{{ route('pagoZaire.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
