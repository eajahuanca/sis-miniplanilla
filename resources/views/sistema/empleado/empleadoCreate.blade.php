...
@section('FormularioDescripcion','registrar nuevo empleado en el sistema')
@section('FormularioActual','Empleados')
@section('FormularioDetalle','Registrar Empleado')
...
@section('ContenidoPagina')
    {!! Form::open(['route' => 'empleado.store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true]) !!}
        @include('sistema.empleado.empleadoForm')
        ...
        <div class="form-group">
            <center>
                ...
                <span class="hint--top  hint--error" aria-label="Cancelar el registro"><a href="{{ route('empleado.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
            </center>
        </div>
    {!! Form::close() !!}
@endsection
