...
@section('FormularioDescripcion','Registrar nuevo usuario en el sistema')
...
@section('ContenidoPagina')
        ...
        {!! Form::open(['route' => 'user.store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true]) !!}
            @include('sistema.usuario.userForm')
            ...
            <div class="form-group">
                <center>
                    ...
                    <span class="hint--top  hint--error" aria-label="Cancelar el registro"><a href="{{ route('user.index') }}" class="btn btn-danger"><i class="fa fa-reply-all"></i> Cancelar</a></span>
                </center>
            </div>
        {!! Form::close() !!}
